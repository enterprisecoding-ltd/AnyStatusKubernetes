...
namespace AnyStatus.Plugins.Kubernetes.PodCPUUsage
{
    ...
    public class PodCPUUsageWidget : Sparkline, IKubernetesWidget, ISchedulable
    {
        /// <summary>
        ...
        [Description("Pod name to retrieve CPU usage")]
